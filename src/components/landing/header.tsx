        ...
        <div className="flex h-[64px] items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/subscription" className="text-[13px] font-[500] text-[#6B6B6B] hover:text-[#0A0A0A] transition">Pricing</Link>
            </nav>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-2 mr-2">
              ...
              <span className="text-[11px] font-[600] tracking-[0.02em] text-[#6B6B6B]">REALTIME • {new Date().toLocaleDateString('id-ID')}</span>
            </div>
            <Link href="/editor">
