      ...
      <div className="mx-auto max-w-[1280px] px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-1 text-[11px] text-[#9B9B9B]">Whisper + Grok-3 • {isId ? 'Terverifikasi' : 'Verified'}</div>
          </div>
          <div className="text-center lg:text-left">
          ...
          <div className="text-center lg:text-left">
            <div className="text-[36px] lg:text-[48px] font-[800] tracking-[-0.04em] leading-none">{formatNumber(stats.total_users)}</div>
            <div className="mt-2 text-[11px] font-[700] tracking-[0.08em] uppercase text-[#6B6B6B]">{isId ? 'Kreator Aktif' : 'Active Creators'}</div>
            <div className="mt-1 text-[11px] text-[#9B9B9B]">{isId ? 'Hari ini' : 'Today'}: {stats.today_views} views • Live</div>
          </div>
        </div>
